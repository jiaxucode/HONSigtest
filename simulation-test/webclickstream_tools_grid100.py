...
STATES = range(0, 100)
save_first_order_rule_variable_direcname = './variable/rules/20231114/1st-order/real/'
# save_first_order_rule_variable_direcname = './variable/rules/20231217/1st-order/real/'
# save_first_order_rule_variable_direcname = './variable/rules/20231229/1st-order/real/'

first_order_trans_pro = np.load(save_first_order_rule_variable_direcname + 'Rules_1st_order_mo4.npy')

save_second_order_rule_variable_direcname = './variable/rules/20231114/2nd-order/real/'
# save_second_order_rule_variable_direcname = './variable/rules/20231217/2nd-order/real/'
# save_second_order_rule_variable_direcname = './variable/rules/20231229/2nd-order/real/'

second_order_trans_pro = LoadVariablestoPickleFile(save_second_order_rule_variable_direcname + 'Rules_2nd_order_mo4.pickle')

save_third_order_rule_variable_direcname = './variable/rules/20231114/3rd-order/real/'
# save_third_order_rule_variable_direcname = './variable/rules/20231217/3rd-order/real/'
# save_third_order_rule_variable_direcname = './variable/rules/20231229/3rd-order/real/'

third_order_trans_pro = LoadVariablestoPickleFile(save_third_order_rule_variable_direcname + 'Rules_3rd_order_mo4'
                                                                                             '.pickle')

save_fourth_order_rule_variable_direcname = './variable/rules/20231114/4th-order/real/'
# save_fourth_order_rule_variable_direcname = './variable/rules/20231217/4th-order/real/'
# save_fourth_order_rule_variable_direcname = './variable/rules/20231229/4th-order/real/'
